...
export const en_US_template: TranslationDict = {
    ...
    // ========== HELP ==========
    help: {
        intro: "Package Guard helps you manage pi extensions and prevent unregistered packages.",
        ...
        scanHelp:
            "Scan - Find and register unregistered packages automatically",
        backupHelp:
            "Backup - Save your package list locally and to GitHub Gist",
        ...
        proTip3:
            "Keep backups current - create one after installing new packages",
    },
};
