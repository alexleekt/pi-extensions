...
- [x] **Escalation to visible nudge** — when the agent loops (same tool calls or duplicate text), the next continue sends a visible user message (exactly `"Keep going."`) instead of an invisible trigger
