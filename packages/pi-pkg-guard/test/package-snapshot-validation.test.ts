        ...
        it("rejects invalid schema URL", () => {
            ...
            assert.ok(
                result.errors.some((e) =>
                    e.includes("Unrecognized schema URL"),
                ),
            );
        });
    ...
    describe("npmPackages validation", () => {
        ...
        it("rejects non-string elements in npmPackages", () => {
            ...
            assert.ok(
                result.errors.some(
                    (e) =>
                        e.includes("npmPackages[1]") ||
                        e.includes("npmPackages[2]"),
                ),
            );
        });
    });
    ...
    describe("excludedPackages validation", () => {
        it("rejects non-array excludedPackages", () => {
            ...
            assert.ok(
                result.errors.some(
                    (e) =>
                        e.includes("excludedPackages") && e.includes("array"),
                ),
            );
        });
        ...
        it("rejects non-string elements in excludedPackages", () => {
            ...
            assert.strictEqual(result.valid, false);
            assert.ok(
                result.errors.some((e) => e.includes("excludedPackages[1]")),
            );
        });
    });
    ...
    describe("additional properties rejection", () => {
        it("rejects unexpected properties", () => {
            ...
            assert.ok(
                result.errors.some(
                    (e) =>
                        e.includes("Unexpected property") &&
                        e.includes("unexpectedField"),
                ),
            );
        });
