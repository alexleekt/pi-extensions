...
## Status
Accepted, amended by [ADR 0004](0004-native-working-message-lifecycle.md)
...
## Decision
Render the heading as a **single plain-text line** through Pi's native `ctx.ui.setWorkingMessage()` surface. Do not use a separate widget, bordered component, background color, or multi-line panel.

## Consequences

- **Positive:** Zero border-fragment ghosting risk. Pi owns the working row and redraw lifecycle.
