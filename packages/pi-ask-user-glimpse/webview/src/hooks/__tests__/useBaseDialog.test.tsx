...
vi.mock("../../components/DialogFooter", () => ({
    default: () => null,
}));

vi.mock("../../components/GlobalKeyboardHint", () => ({
    default: () => null,
}));

vi.mock("../../components/FooterContext", async () => {
    const React = await import("react");
    const FooterContext = React.createContext({ setFooter: () => {} });
    return {
        useFooterPortal: () => {},
        FooterContext,
    };
...
describe("useBaseDialog", () => {
    ...
    it("handleSubmit sets isSubmitting=true before calling onSubmit", async () => {
    ...
    it("handleCancel shows cancel-confirm when dirty", async () => {
        const { result } = renderHook(
            () =>
                useBaseDialog({
                    payload: defaultPayload,
        ...
        await waitFor(() => expect(result.current.showCancelConfirm).toBe(true));
    ...
    it("handleCancel returns early when isSubmitting is true", async () => {
        const onSubmit = vi.fn();
        const { result } = renderHook(
            () =>
                useBaseDialog({
